...
const ADDONS = {
  ...
  desk:          { price: 9000, name: "桌椅組 Desk & chair (desk W100×D60×H70cm)" },
  low_table:     { price: 6000, name: "和式桌 Low table (W75×D50×H31.5cm)" },
...
module.exports = async function handler(req, res) {
  ...
  // 不開 phone_number_collection：Stripe 只有「強制填」模式，會擋住剛來日本
  // 還沒辦手機號的客人。電話改事後用 LINE 補要（tools/request_phone_via_line.js）。
