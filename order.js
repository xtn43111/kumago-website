...
(function () {
  ...
  const ADDONS = [
    ...
    { key: "desk",          price: 9000, zh: "桌椅組",       ja: "デスク・チェアセット", en: "Desk & chair set",
      note: { zh: "桌子尺寸：寬100×深60×高70cm",
              ja: "机サイズ：幅100×奥行60×高70cm",
              en: "Desk size: W100×D60×H70cm" } },
    { key: "low_table",     price: 6000, zh: "和式桌",       ja: "和式テーブル", en: "Low table",
      note: { zh: "桌子尺寸：寬75×深50×高31.5cm",
              ja: "テーブルサイズ：幅75×奥行50×高31.5cm",
              en: "Table size: W75×D50×H31.5cm" } },
